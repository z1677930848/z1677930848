...
func (this *IndexAction) RunGet(params struct{}) {
	...
	// GlobalConfig renamed to GlobalServerConfig in EdgeCommon 1.0.0
	globalConfig := &serverconfigs.GlobalServerConfig{}

	// 默认值
	// globalConfig.HTTPAll.DomainAuditingIsOn = false // Field may not exist
